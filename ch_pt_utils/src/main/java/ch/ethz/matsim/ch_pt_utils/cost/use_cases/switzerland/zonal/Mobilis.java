...
import ch.ethz.matsim.ch_pt_utils.cost.use_cases.switzerland.zonal.pricing.MobilisPricing;
...
public class Mobilis {
	...
	static public ZonalTicketGenerator createTicketGenerator(ZonalRegistry zonalRegistry) {
		Authority authority = zonalRegistry.getAuthority("Mobilis");
		return new DefaultZonalTicketGenerator(authority, new MobilisPricing());
	}
}
